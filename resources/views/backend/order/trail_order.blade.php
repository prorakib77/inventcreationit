<x-app-layout>
    ...
    <div class="py-12">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($orders as $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <img style="width: 90px; border-radius: 5px" class="w-100" src="{{ asset($order->file) }}" alt="Order Image">
                                            </td>
                                            <td
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 pt-5 text-center">
            <a href="{{ route('dashboard') }}" class="btn btn-outline btn-info">Go Back -></a>
        </div>
    </div>
</x-app-layout>
